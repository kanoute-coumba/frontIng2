...
public class SpaceRepo {
    ...
    public Iterable<Space> getSpacesOfFloorByType(String name_floor, String type_space) {
        ResponseEntity<Iterable<Space>> responseEntity =
                restTemplate.exchange(customProperties.getApiLocalArchitectureUrl() + "/spaces_of_floor_by_type/" + name_floor + "/" + type_space, HttpMethod.GET, null, new ParameterizedTypeReference<>() {});
        return responseEntity.getBody();
    }
